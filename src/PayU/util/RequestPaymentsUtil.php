...
use Jlorente\PayU\PayU\api\PaymentMethods;
use Jlorente\PayU\PayU\api\PayUCommands;
use Jlorente\PayU\PayU\api\PayUConfig;
use Jlorente\PayU\PayU\api\PayUKeyMapName;
...
class RequestPaymentsUtil extends CommonRequestUtil
{
    ...
    static function buildPaymentRequest($parameters, $transactionType, $lang = null)
    {
        ...
        } else if (TransactionType::VOID == $transactionType || TransactionType::REFUND == $transactionType || TransactionType::CAPTURE == $transactionType) {
    ...
    private static function buildOrderRequest($parameters, $lang)
    {
        ...
        $order->additionalValues = RequestPaymentsUtil::buildOrderAdditionalValues(CommonRequestUtil::getParameter($parameters, PayUParameters::CURRENCY),
